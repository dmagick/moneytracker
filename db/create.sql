...
CREATE FUNCTION money_account_transactions() RETURNS trigger AS $money_account_transactions$
  BEGIN
    IF (TG_OP = 'INSERT') THEN
      INSERT INTO money_account_transactions_log(transaction_id, transaction_amount, transaction_date, transaction_description, transaction_by, transaction_type, account_id, account_balance_previous, account_balance_new)
      SELECT
        t.transaction_id, t.transaction_amount, t.transaction_date, t.transaction_description, t.transaction_by, t.transaction_type, t.account_id, a.account_balance, a.account_balance + NEW.transaction_amount
      FROM
